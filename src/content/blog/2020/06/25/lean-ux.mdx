...
thumbnail: ./images/lean_UX_1.jpg
...
![Lean UX is a company effort - roles and responsibilities](./images/lean_ux_company_effort.png "Lean UX is a company effort")
...
![Lean UX is iterative - problem, solution and build phases](./images/lean_ux_iterative.png "Lean UX is iterative")
...
![Lean UX is data-driven - adoption & frequency determine strategy](./images/lean_ux_data_driven.png "Lean UX is data-driven")
...
![Lean UX is pain-driven - idnetify the pain the user has with the feature](./images/lean_ux_pain_driven.png "Lean UX is pain-driven")
